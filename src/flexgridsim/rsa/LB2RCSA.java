...
public class LB2RCSA extends XTFFRCSA {
...
//			System.out.println(getFragmentatioRatio());
...
//			ArrayList<Integer> priorityCores = new ArrayList<Integer>(Arrays.asList(1, 5, 3, 4, 6 , 2 , 0));
		...
		public double getFragmentatioRatio(int []links) {
...
//			if(w < 0.2) System.out.println((1.0 - w));
			return (1.0 - w);
		}
