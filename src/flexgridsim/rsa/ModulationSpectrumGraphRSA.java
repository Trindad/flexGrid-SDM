 ...
 * @author pedrom
 */
public class ModulationSpectrumGraphRSA implements RSA {
...
//	public double calculateCost(int src, int dst, int firstSlot, int demand, int modulationLevel) {
//		 double cost =  (double)((demand-2)*Modulations.getPowerConsumption(modulationLevel));// + (demand/pt.getNumSlots()) * (pt.getNodeDegree(dst)*85+150);
